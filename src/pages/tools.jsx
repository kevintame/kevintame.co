      ...
      >
        <div className="space-y-20">
          ...
          <ToolsSection title="Development tools">
            ...
            <Tool title="Terminal">
              I know people like iTerm but I don't even know the benefits I get by using it. So I just have stuck with built in terminal.
            </Tool>
          </ToolsSection>
          <ToolsSection title="Design">
            <Tool title="Sketch">
              I love the speed in which I can design things up. It probably doesn't have all the bells and whistles of other design tools but it's light weight and easy to use. 
            </Tool>
          ...
          <ToolsSection title="Fun">
            <Tool title="Switch OLED">
              Nintendo's lack of quality family sharing pisses me off, but I can't deny it's one of the best gaming consoles every made. It's my go to for video game fun.
            </Tool>
            <Tool title="Burton Custom 162">
              I've been riding a custom for a very long time and everytime I try another board it just doesn't cut it for me. 
            </Tool>
            <Tool title="Black Diamond Helio 105">
              I'm not a great skiier but these things are really light and great for uphill travel. I've been very pleased with them and I think you would like them to.
            </Tool>
            <Tool title="Danner Mountain 600">
              My dad had Danner boots when I was growing up. When I finally was old enough to get my own I never looked back. 
            </Tool>
          </ToolsSection>
        </div>
      </SimpleLayout>

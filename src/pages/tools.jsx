    ...
    <>
      ...
      >
        ...
        <ToolsSection title="Productivity">
          <Tool title="Things">
            For more than a decade, the Things app has helped me stay organized with the tasks I need to get done.
          </Tool>
          <Tool title="Obsidian">
            I love being able to keep all my notes as markdown files. The customization options are another great reason to use Obsidian.
          </Tool>
        </ToolsSection>
        ...
        <ToolsSection title="Adventure Gear">
          ...
          <Tool title="Dynastar Tour 99">
            I’m not a great skier, but these are light and great for uphill travel. I’ve been very pleased with them, and I think you would like them too.
          </Tool>
          <Tool title="Dynafit Radical Pro Boots">
            It took me a long time.
          </Tool>
          <Tool title="Brooks Cascadia">
